...
/*   Updated: 2023/02/25 17:19:27 by hkaddour         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	//check in the parsing if this file exist
	data->sprite[0].img = mlx_xpm_file_to_image(data->mlx->init, \
			"./sprites/gun_2.xpm", &data->sprite[0].w, &data->sprite[0].h);
	data->sprite[0].addr = mlx_get_data_addr(\
			data->sprite[0].img, &data->sprite[0].bpp, \
			&data->sprite[0].size_line, &data->sprite[0].endian);
